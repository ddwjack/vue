    ...
    <section class="wrapper col_fff">
        ...
        <section class="aui-grid">
            <div class="aui-row" id="div_list_f">
                ...
                <div class="aui-col-xs-3 pt-list" v-for="item in data" @click="wwLive(item.linkurl)">
...
<script>
    ...
    export default {
        ...
        mounted(){
            ...
            this.$ajax({
                method: 'get',
                url: `${this.baseUrl}login/login/banben.html`,
                dataType:'json',
        ...
        methods:{
            wwLive(url) {
                this.GLOBAL.AalertMsg()
                console.log(url)
                this.$router.push({name: 'homeVideo', params:{ id: url}})
                // this.$router.push('/dailiguanli')
